...
class TokenUsage(BaseModel):
    ...
    TokenUsage
    """ # noqa: E501
    prompt_tokens: Optional[StrictInt] = Field(default=None, description="Tokens in the prompt")
    completion_tokens: Optional[StrictInt] = Field(default=None, description="Tokens generated")

...
class ChatCompletionResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique completion ID")
    object: Optional[StrictStr] = None
    created: Optional[StrictInt] = Field(default=None, description="Unix timestamp")
    model: Optional[StrictStr] = Field(default=None, description="Model used for completion")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "usage": TokenUsage.from_dict(obj.get("usage")) if obj.get("usage") is not None else None
        })
        return _obj

...
class StorageObject(BaseModel):
    ...
    StorageObject
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Storage key (project prefix stripped)")
    ...
    __properties: ClassVar[List[str]] = ["key", "size", "lastModified", "contentType", "etag"]

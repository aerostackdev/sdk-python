...
class ListTypes200Response(BaseModel):
    """
    ListTypes200Response
    """ # noqa: E501
    types: Optional[List[TypeStats]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "types": [TypeStats.from_dict(_item) for _item in obj.get("types")] if obj.get("types") is not None else None
        })
        return _obj

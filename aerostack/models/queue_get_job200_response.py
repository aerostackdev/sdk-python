...
class QueueGetJob200Response(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of QueueGetJob200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of QueueGetJob200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "job": JobRecord.from_dict(obj.get("job")) if obj.get("job") is not None else None,

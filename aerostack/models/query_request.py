...
class QueryRequest(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr
    top_k: Optional[StrictInt] = Field(default=5, alias="topK")
    types: Optional[List[StrictStr]] = None
    filter: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["text", "topK", "types", "filter"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "topK": obj.get("topK") if obj.get("topK") is not None else 5,
            "types": obj.get("types"),
        })
        return _obj

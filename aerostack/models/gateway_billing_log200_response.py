...
class GatewayBillingLog200Response(BaseModel):
    """
    GatewayBillingLog200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    logged_units: Optional[StrictInt] = Field(default=None, alias="loggedUnits")
    __properties: ClassVar[List[str]] = ["success", "loggedUnits"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "loggedUnits": obj.get("loggedUnits")
        })
        return _obj

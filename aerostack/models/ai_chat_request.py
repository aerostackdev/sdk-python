...
class AiChatRequest(BaseModel):
    ...
    messages: List[AiChatRequestMessagesInner]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "model": obj.get("model"),
            "messages": [AiChatRequestMessagesInner.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None
        })
        return _obj
